...
public class TestMessageProducer {
	...
	public static void main(String[] args) {	
		...
		mp = new TextfileProducer("files/new.txt");
		//writeToObjectStream("src/files/new.dat",getArrayProducer(4,200));
		//MessageProducer mp = new ObjectfileProducer("src/files/new.dat");
		Message message;
		int times = mp.times();
		int delay = mp.delay();
		int size = mp.size();
